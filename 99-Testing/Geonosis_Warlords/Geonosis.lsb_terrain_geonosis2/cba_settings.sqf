...
force ace_medical_bleedingCoefficient = 600;
...
force ace_medical_engine_damagePassThroughEffect = 0.701618;
...
force ace_medical_playerDamageThreshold = 0.75;
force ace_medical_spontaneousWakeUpChance = 0.346505;
...
// LRG AI
LRG_AI_AimingAccuracy = 0.1;
LRG_AI_AimingShake = 0.45;
LRG_AI_AimingSpeed = 0.3;
LRG_AI_CivCourage = 1;
...
LRG_AI_ReloadSpeed = 0.5;
LRG_AI_Reporting = false;
LRG_AI_SpotDistance = 0.4;
LRG_AI_SpotTime = 0.2;
