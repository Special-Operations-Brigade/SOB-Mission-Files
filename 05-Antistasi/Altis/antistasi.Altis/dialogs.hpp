...
class radio_comm 		{
	...
	class controls {
		...
		class 8slots_L4: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Several AI options depending on units or squads selected";
			action = "if (player == leader group player) then {closeDialog 0;if (hcShownBar) then {nul = createDialog ""squad_management""} else {nul = createDialog ""AI_management""}} else {hint ""Only group leaders may access to this option""};";
		};
...
class AI_management 		{
	...
	class controls {
		...
		class 8slots_L1: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Take personal control of the selected squad member and be able to perform any kind of actions for 60 seconds. Control state will be cancelled if the player or the controlled unit receives any kind of damage";
		...
		{
			idc = -1;
			text = "Garrison Units"; //--- ToDo: Localize;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.415981 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Adds selected units to a map selected garrison";
		...
		{
			idc = -1;
			text = "Dismiss Units"; //--- ToDo: Localize;
			x = 0.37749 * safezoneW + safezoneX;
			y = 0.612025 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Dimiss selected units, recovering it's cost to the proper resource pool";
...
class squad_management 		{
	...
	class controls {
		...
		class 8slots_L1: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Take personal control of the selected HC squad leader and be able to perform any kind of actions for 60 seconds. Control state will be cancelled if the player or the controlled unit receives any kind of damage";
			action = "closeDialog 0; if ((count groupselectedUnits player > 0) and (count hcSelected player > 0)) exitWith {hint ""You must select from HC or Squad Bars, not both""}; if (count groupselectedUnits player == 1) then {nul = [groupselectedUnits player] execVM ""REINF\controlunit.sqf""}; if (count hcSelected player == 1) then {nul = [hcSelected player] execVM ""REINF\controlHCsquad.sqf"";};";
		};
		class 8slots_R1: RscButton
		{
			idc = -1;
			text = "Berserker Mode"; //--- ToDo: Localize;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Squad will fight less caring of their lives";
			action = "[""berserk""] call A3A_fnc_vehStats;";
		};
		class 8slots_L2: RscButton
		{
			idc = -1;
			text = "Ambush Mode"; //--- ToDo: Localize;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.415981 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "AI will hold fire and remain hidden";
			action = "[""ambush""] call A3A_fnc_vehStats;";
		};
		class 8slots_R2: RscButton
		{
			idc = -1;
		...
		{
			idc = -1;
			text = "Garrison Squad"; //--- ToDo: Localize;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.514003 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Adds selected squad to a map selected garrison";
			action = "closeDialog 0;if (count groupselectedUnits player > 0) then {nul = [groupselectedUnits player] execVM ""REINF\addToGarrison.sqf""} else {if (count (hcSelected player) > 0) then {nul = [hcSelected player] execVM ""REINF\addToGarrison.sqf""}}; if ((count groupselectedUnits player == 0) and (count hcSelected player == 0)) then {hint ""No units or squads selected""}";
		};
		class 8slots_R3: RscButton
		{
		...
		{
			idc = -1;
			text = "Dismiss Squad"; //--- ToDo: Localize;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.612025 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Dimiss selected squad, recovering it's cost to the proper resource pool";
			action = "closeDialog 0;if (count groupselectedUnits player > 0) then {nul = [groupselectedUnits player] execVM ""REINF\dismissPlayerGroup.sqf""} else {if (count (hcSelected player) > 0) then {nul = [hcSelected player] execVM ""REINF\dismissSquad.sqf""}}; if ((count groupselectedUnits player == 0) and (count hcSelected player == 0)) then {hint ""No units or squads selected""}";
		};
		class 8slots_R4: RscButton
		{
...
class gameMode_menu 			{
	...
	class controls {
		...
		{
			idc = 105;
			text = "Reb vs Gov & Inv"; //--- ToDo: Localize;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
