...
_totalPop = _totalPop / (count ciudades);
{
if (((server getVariable _x) select 0) < _totalPop) then {minorCities pushBack _x};
} forEach ciudades;
