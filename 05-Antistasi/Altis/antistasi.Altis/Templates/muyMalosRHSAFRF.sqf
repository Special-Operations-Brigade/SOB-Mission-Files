...
CSATmedic = "rhs_vdv_mflora_medic";
CSATAA = "rhs_vdv_flora_aa";
CSATAT = "rhs_vdv_flora_at";
CSATMortarMan = "";
CSATEngineer = "rhs_vdv_flora_engineer";
CSATMGSupp = "";
CSATMortSupp = "";
...
gruposCSATAA = ["rhs_vdv_flora_junior_sergeant",CSATAA,CSATAA,CSATAA];
gruposCSATAT = ["rhs_vdv_flora_junior_sergeant",CSATAT,"rhs_vdv_flora_strelok_rpg_assist","rhs_vdv_flora_LAT"];
...
CSATSquad = ["rhs_vdv_mflora_sergeant","rhs_vdv_mflora_junior_sergeant","rhs_vdv_mflora_grenadier","rhs_vdv_mflora_machinegunner","rhs_vdv_mflora_at","rhs_vdv_mflora_strelok_rpg_assist","rhs_vdv_mflora_rifleman",CSATmedic];

CSATSquadAA = ["rhs_vdv_mflora_sergeant","rhs_vdv_mflora_junior_sergeant","rhs_vdv_mflora_machinegunner","rhs_vdv_mflora_rifleman",CSATMarksman,"rhs_vdv_mflora_machinegunner_assistant",CSATAA,CSATmedic];
CSATSquadMortar = [];
CSATSquadMG = [];
CSATSquadEng = ["rhs_vdv_mflora_sergeant","rhs_vdv_mflora_junior_sergeant","rhs_vdv_mflora_machinegunner","rhs_vdv_mflora_rifleman",CSATEngineer,"rhs_vdv_mflora_machinegunner_assistant",CSATEngineer,CSATmedic];
CSATSquadAT = ["rhs_vdv_mflora_sergeant","rhs_vdv_mflora_junior_sergeant","rhs_vdv_mflora_machinegunner","rhs_vdv_mflora_rifleman",CSATAT,"rhs_vdv_mflora_machinegunner_assistant",CSATAT,CSATmedic];
...
gruposCSATSquad = [CSATSquad,CSATSquadAA,CSATSquadEng,CSATSquadAT];//[CSATSquad,"O_T_InfSquad_Weapons"];///
