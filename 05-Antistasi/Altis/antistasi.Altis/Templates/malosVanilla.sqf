...
NATOmedic = "B_T_medic_F";
NATOAA = "B_T_soldier_AA_F";
NATOAT = "B_T_soldier_AT_F";
NATOMortarMan = "B_T_Support_Mort_F";
NATOEngineer = "B_T_engineer_F";
NATOMGSupp = "B_T_support_AMG_F";
NATOMortSupp = "B_T_support_AMort_F";
...
gruposNATOAA = ["B_T_soldier_TL_F",NATOAA,NATOAA,"B_T_soldier_AAA_F"];
gruposNATOAT = ["B_T_soldier_TL_F",NATOAT,NATOAT,"B_T_soldier_AAT_F"];
...
NATOSquad = ["B_T_soldier_SL_F",NATOGrunt,"B_T_soldier_LAT_F",NATOMarksman,"B_T_soldier_TL_F","B_T_soldier_AR_F","B_T_soldier_A_F",NATOmedic];//"B_T_InfSquad";//

NATOSquadAA = ["B_T_soldier_SL_F","B_T_soldier_AR_F","B_T_soldier_GL_F",NATOMarksman,NATOAA,"B_T_soldier_AAA_F","B_T_soldier_A_F",NATOmedic];
NATOSquadMortar = ["B_T_soldier_SL_F","B_T_soldier_LAT_F","B_T_soldier_TL_F","B_T_soldier_AR_F","B_T_soldier_A_F",NATOMortarMan,NATOMortSupp,NATOmedic];
NATOSquadMG = ["B_T_soldier_SL_F","B_T_soldier_LAT_F","B_T_soldier_TL_F","B_T_soldier_AR_F","B_T_soldier_A_F",staticCrewMalos,NATOMGSupp,NATOmedic];
NATOSquadEng = ["B_T_soldier_SL_F","B_T_soldier_AR_F","B_T_soldier_GL_F",NATOMarksman,NATOEngineer,NATOEngineer,"B_T_soldier_A_F",NATOmedic];
NATOSquadAT = ["B_T_soldier_SL_F","B_T_soldier_AR_F","B_T_soldier_GL_F",NATOMarksman,NATOAT,"B_T_soldier_AAT_F","B_T_soldier_A_F",NATOmedic];
...
gruposNATOSquad = [NATOSquad,NATOSquadAA,NATOSquadMortar,NATOSquadMG,NATOSquadAT];
