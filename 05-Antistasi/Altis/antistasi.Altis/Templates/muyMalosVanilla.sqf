...
CSATmedic = "O_T_medic_F";
CSATAA = "O_T_soldier_AA_F";
CSATAT = "O_T_soldier_AT_F";
CSATMortarMan = "O_T_Support_Mort_F";
CSATEngineer = "O_T_Engineer_F";
CSATMGSupp = "O_T_support_AMG_F";
CSATMortSupp = "O_T_Support_AMort_F";
...
gruposCSATAA = ["O_T_soldier_TL_F",CSATAA,CSATAA,"O_T_soldier_AAA_F"];
gruposCSATAT = ["O_T_soldier_TL_F",CSATAT,CSATAT,"O_T_soldier_AAT_F"];
...
CSATSquad = ["O_T_soldier_SL_F","O_T_soldier_F","O_T_soldier_LAT_F","O_T_soldier_M_F","O_T_soldier_TL_F","O_T_soldier_AR_F","O_T_soldier_A_F",CSATmedic];

CSATSquadAA = ["O_T_soldier_SL_F","O_T_soldier_LAT_F","O_T_soldier_TL_F","O_T_soldier_AR_F","O_T_soldier_A_F",CSATAA,"O_T_soldier_AAA_F",CSATmedic];
CSATSquadMortar = ["O_T_soldier_SL_F","O_T_soldier_LAT_F","O_T_soldier_TL_F","O_T_soldier_AR_F","O_T_soldier_A_F",CSATMortarMan,CSATMortSupp,CSATmedic];
CSATSquadMG = ["O_T_soldier_SL_F","O_T_soldier_LAT_F","O_T_soldier_TL_F","O_T_soldier_AR_F","O_T_soldier_A_F",staticCrewMuyMalos,CSATMGSupp,CSATmedic];
CSATSquadEng = ["O_T_soldier_SL_F","O_T_soldier_LAT_F","O_T_soldier_TL_F","O_T_soldier_AR_F","O_T_soldier_A_F",CSATmedic,CSATEngineer,CSATEngineer];
CSATSquadAT = ["O_T_soldier_SL_F","O_T_soldier_AR_F","O_T_soldier_GL_F","O_T_soldier_M_F",CSATAT,"O_T_soldier_AAT_F","O_T_soldier_A_F",CSATmedic];
...
gruposCSATSquad = [CSATSquad,CSATSquadAA,CSATSquadMortar,CSATSquadMG,CSATSquadEng,CSATSquadAT];
