...
CSATmedic = "O_medic_F";
CSATAA = "O_soldier_AA_F";
CSATAT = "O_soldier_AT_F";
CSATMortarMan = "O_Support_Mort_F";
CSATEngineer = "O_engineer_F";
...
vehCSATMRLSMags = "32Rnd_155mm_Mo_shells_O"; //[pepe,"mortar_155mm_AMOS","mortar_155mm_AMOS","Single1","Sh_155mm_AMOS","32Rnd_155mm_Mo_shells_O",16: shell.p3d,pepeG]
...
gruposCSATAA = ["O_soldier_TL_F",CSATAA,CSATAA,"O_soldier_AAA_F"];
gruposCSATAT = ["O_soldier_TL_F",CSATAT,CSATAT,"O_soldier_AAT_F"];
gruposCSATmid = [["O_soldier_TL_F","O_soldier_AR_F","O_soldier_GL_F","O_soldier_LAT_F"],gruposCSATAA,gruposCSATAT];
CSATSquad = ["O_soldier_SL_F","O_soldier_F","O_soldier_LAT_F","O_soldier_M_F","O_soldier_TL_F","O_soldier_AR_F","O_soldier_A_F",CSATmedic];

CSATSquadAA = ["O_soldier_SL_F","O_soldier_LAT_F","O_soldier_TL_F","O_soldier_AR_F","O_soldier_A_F",CSATAA,"O_soldier_AAA_F",CSATmedic];
CSATSquadMortar = ["O_soldier_SL_F","O_soldier_LAT_F","O_soldier_TL_F","O_soldier_AR_F","O_soldier_A_F",CSATMortarMan,CSATMortSupp,CSATmedic];
CSATSquadMG = ["O_soldier_SL_F","O_soldier_LAT_F","O_soldier_TL_F","O_soldier_AR_F","O_soldier_A_F",staticCrewMuyMalos,CSATMGSupp,CSATmedic];
CSATSquadEng = ["O_soldier_SL_F","O_soldier_LAT_F","O_soldier_TL_F","O_soldier_AR_F","O_soldier_A_F",CSATEngineer,CSATEngineer,CSATmedic];
CSATSquadAT = ["O_soldier_SL_F","O_soldier_AR_F","O_soldier_GL_F","O_soldier_M_F",CSATAT,"O_soldier_AAT_F","O_soldier_A_F",CSATmedic];
