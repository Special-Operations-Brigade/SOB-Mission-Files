...
NATOmedic = "rhsgref_ins_g_medic";
NATOAA = "rhsgref_ins_g_specialist_aa";
NATOAT = "rhsgref_ins_g_grenadier_rpg";
NATOMortarMan = "";
NATOEngineer = "rhsgref_ins_g_saboteur";
NATOMGSupp = "";
NATOMortSupp = "";
...
gruposNATOSniper = [NATOMarksman,"rhsgref_ins_g_spotter"];
gruposNATOsmall = [gruposNATOSentry,gruposNATOSniper]; //[gruposNATOSentry,"B_T_SniperTeam","B_T_ReconSentry"];///
gruposNATOAA = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner",NATOAA,NATOAA];
gruposNATOAT = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner",NATOAT,NATOAT];
...
NATOSquad = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner","rhsgref_ins_g_machinegunner","rhsgref_ins_g_rifleman_RPG26","rhsgref_ins_g_rifleman","rhsgref_ins_g_rifleman_RPG26","rhsgref_ins_g_grenadier",NATOmedic];

NATOSquadAA = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner","rhsgref_ins_g_machinegunner","rhsgref_ins_g_rifleman","rhsgref_ins_g_rifleman_RPG26",NATOAA,"rhsgref_ins_g_grenadier",NATOmedic];
NATOSquadMortar = [];
NATOSquadMG = [];
NATOSquadEng = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner","rhsgref_ins_g_machinegunner","rhsgref_ins_g_rifleman","rhsgref_ins_g_rifleman_RPG26",NATOEngineer,NATOEngineer,NATOmedic];
NATOSquadAT = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner","rhsgref_ins_g_machinegunner","rhsgref_ins_g_rifleman","rhsgref_ins_g_rifleman_RPG26",NATOAT,"rhsgref_ins_g_rifleman_RPG26",NATOmedic];

NATOSpecOp = ["rhsgref_ins_g_grenadier","rhsgref_ins_g_spotter","rhsgref_ins_g_grenadier","rhsgref_ins_g_machinegunner",NATOMarksman,NATOEngineer,"rhsgref_ins_g_rifleman_RPG26",NATOmedic];//(configfile >> "CfgGroups" >> "West" >> "BLU_CTRG_F" >> "Infantry" >> "CTRG_InfSquad");
factionMachoMalos = "";
