...
NATOmedic = "rhsusf_navy_sarc_w_fast";
NATOAA = "rhsusf_usmc_marpat_wd_stinger";
NATOAT = "rhsusf_usmc_marpat_wd_javelin";
NATOMortarMan = "";
NATOEngineer = "rhsusf_usmc_marpat_d_explosives";
NATOMGSupp = "";
NATOMortSupp = "";
...
gruposNATOAA = ["rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4",NATOAA];
gruposNATOAT = ["rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4",NATOAT];
gruposNATOmid = [["rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4","rhsusf_usmc_marpat_wd_riflemanat"],gruposNATOAA,gruposNATOAT];
NATOSquad = ["rhsusf_usmc_marpat_wd_squadleader","rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4",NATOmedic,"rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4","rhsusf_usmc_marpat_wd_marksman",NATOmedic];

NATOSquadAA = ["rhsusf_usmc_marpat_d_squadleader","rhsusf_usmc_marpat_d_machinegunner","rhsusf_usmc_marpat_d_riflemanat","rhsusf_usmc_marpat_d_grenadier","rhsusf_usmc_marpat_d_grenadier",NATOAA,"rhsusf_usmc_marpat_d_rifleman_light",NATOmedic];
NATOSquadMortar = [];
NATOSquadMG = [];
NATOSquadEng = ["rhsusf_usmc_marpat_wd_squadleader","rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4",NATOEngineer,NATOmedic];
NATOSquadAT = ["rhsusf_usmc_marpat_d_squadleader","rhsusf_usmc_marpat_d_machinegunner","rhsusf_usmc_marpat_d_riflemanat","rhsusf_usmc_marpat_d_riflemanat","rhsusf_usmc_marpat_d_grenadier",NATOAT,"rhsusf_usmc_marpat_d_javelin_assistant","rhsusf_navy_sarc_d"];
