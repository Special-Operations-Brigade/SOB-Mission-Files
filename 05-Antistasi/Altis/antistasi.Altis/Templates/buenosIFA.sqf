...
SDKFlagTexture = if (worldName == "chernarus_summer") then {"ak.jpg"} else {"Templates\A3-ArmiaKrajowaTemplate.chernarus_summer\ak.jpg"}; if (isServer) then {bandera setFlagTexture SDKFlagTexture};
