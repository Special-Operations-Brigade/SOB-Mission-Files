...
_tipo = typeOf _unit;
_loadout = SDKMil select 0;
switch _tipo do
	{
	case "I_G_officer_F": {_loadout = SDKSL select 0};
	case "I_G_Soldier_AR_F": {_loadout = SDKMG select 0};
	case "I_G_Soldier_LAT2_F": {_loadout = SDKATman select 0};
	case "I_G_medic_F": {_loadout = SDKMedic select 0};
	case "I_G_engineer_F": {_loadout = SDKEng select 0};
	case "I_G_Soldier_GL_F": {_loadout = SDKGL select 0};
