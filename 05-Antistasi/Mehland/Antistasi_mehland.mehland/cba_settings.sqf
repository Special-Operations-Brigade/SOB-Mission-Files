...
// HELLDIVERS Stratagems + Extras
force HD2_Autocannon_Sentry_Setting = "MTI_BlasterTurret";
force HD2_Eagle_Supports_classname = "MTI_arc_170";
HD2_Eagle_Supports_Cooldown = "120";
force HD2_Eagle_Supports_Limit = "2";
force HD2_Eagle_Supports_Name = "CC-1452 Rat";
HD2_Eagle_Supports_UseSubtitles = true;
force HD2_Eagle_Supports_UseVoice = false;
force HD2_Gatling_Sentry_Setting = "MTI_BlasterTurret";
force HD2_MachineGun_Sentry_Setting = "MTI_BlasterTurret";
force HD2_Mortar_Sentry_Setting = "MTI_Mortar";
force HD2_Rocket_Sentry_Setting = "mti_mortar_turret";
HD2_SL_Supports_Only = false;
HD2_Supports_VoiceTypes = false;
HELLDIVERS_AdaptiveMusic_CombatDuration = 5;
HELLDIVERS_AdaptiveMusic_Debug = false;
HELLDIVERS_AdaptiveMusic_SafeDuration = 15;
force HELLDIVERS_AdaptiveMusic_Setting = false;
