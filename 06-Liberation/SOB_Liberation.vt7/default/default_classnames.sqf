...
Arsenal_typename = "mti_armoury_props_locker_base";
Box_Weapon_typename = "Box_NATO_Wps_F";
Box_Ammo_typename = "mti_armoury_supplies_crate_trooper_squad";
Box_Support_typename = "mti_armoury_supplies_crate_common_medical_adv";
Box_Launcher_typename = "Box_NATO_WpsLaunch_F";
Box_Special_typename = "Box_NATO_WpsSpecial_F";
Box_Explosives_typename = "mti_armoury_supplies_crate_common_explosives";
Box_Grenades_typename = "mti_armoury_supplies_crate_common_ammo_gl";
Box_Equipment_typename = "mti_armoury_supplies_crate_common_equipment";
...
playerbox_typename = "Land_MetalCase_01_large_F";
...
opfor_statics = [];
opfor_boats = [];
money_typename = "3AS_Intel_CreditCase_Prop";
...
PAR_grave_box_typename = "mti_armoury_props_medical_coffin";
PAR_Medikit = "Medikit";
