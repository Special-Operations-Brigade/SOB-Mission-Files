...
// Execute in console
// [] execVM "dump_classname.sqf";

private _hiarachy = [];
private _classes = ( "isClass _x" configClasses( configFile >> "CfgVehicles" ));
...
systemchat "All Vehicles classname are copied to the clipboard, thanks Larrow!"
