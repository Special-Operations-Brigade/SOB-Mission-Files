...
opfor_squad_leader = "mti_factions_cis_B1_prototype_base";                                  // Squad Leader
opfor_team_leader = "mti_factions_cis_B1_SL_S";                                   // Team Leader
opfor_sentry = "mti_factions_cis_B1_E5_S";                                      // Rifleman (Lite)
opfor_rifleman = "mti_factions_cis_B1_E5_S";                                         // Rifleman
opfor_rpg = "mti_factions_cis_B1_AT_S";                                          // Rifleman (LAT)
opfor_grenadier = "mti_factions_cis_B1_Heavy";                                     // Grenadier
opfor_machinegunner = "mti_factions_cis_B1_Support_S";                                 // Autorifleman
opfor_heavygunner = "mti_factions_cis_B2";                                  // Heavy Gunner
opfor_marksman = "mti_factions_cis_BX_Snow_Sniper";                                       // Marksman
opfor_sharpshooter = "mti_factions_cis_B2_Speed";                                // Sharpshooter
opfor_sniper = "mti_factions_cis_BX_Snow_Sniper";                                            // Sniper
opfor_at = "mti_factions_cis_B1_AT_Heavy";                                            // AT Specialist
opfor_aa = "mti_factions_cis_B1_AA_Heavy";                                            // AA Specialist
opfor_medic = "mti_factions_cis_B1_E5_S";                                              // Combat Life Saver
opfor_engineer = "mti_factions_cis_B2_Flamer";                                        // Engineer
opfor_paratrooper = "mti_factions_cis_BX_Snow_E5";                                   // Paratrooper
...
militia_squad = [
    "mti_factions_cis_B1_Support_S",                                                     // Rifleman (Lite)
    "mti_factions_cis_B1_E5_S",                                                     // Rifleman (Lite)
    "mti_factions_cis_Snow_Rifleman",                                                     // Rifleman
    "mti_factions_cis_B1_AT_S",                                                     // Rifleman
    "mti_factions_cis_Snow_AT",                                                 // Rifleman (AT)
    "mti_factions_cis_Snow_MG",                                                  // Autorifleman
    "mti_factions_cis_Snow_Sniper",                                                   // Marksman
    "mti_factions_cis_BX_Snow_Sniper",                                               // Medic
    "mti_factions_cis_B1_AA_S"                                                    // Engineer
];
...
militia_vehicles = [
    ...
    "mti_factions_cis_AAT_Winter",
    "mti_factions_cishuman_Rat",
    "mti_factions_cis_GAT_Light_Snow",
    "mti_factions_cis_GAT_Light_Snow",
...
opfor_vehicles = [
    "mti_factions_cis_AAT_Winter",                                                  // Ifrit (HMG)
    ...
    "mti_factions_cis_GAT_Snow",                                            // ZSU-39 Tigris
...
opfor_battlegroup_vehicles = [
    ...
    "mti_factions_cis_GAT_AA",                                            // ZSU-39 Tigris
    "mti_factions_cis_AAT_Winter",                                                // T-100 Varsuk
    "mti_factions_cis_GAT_Snow",                                                // T-100 Varsuk
