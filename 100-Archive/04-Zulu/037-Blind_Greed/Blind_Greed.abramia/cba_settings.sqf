...
force ScifiSupportPlus_DroidDispenser = false;
...
force ScifiSupportPlus_IonCannonVolley = false;
...
force ScifiSupportPlus_OrbitalBlasterCannonBlue = false;
force ScifiSupportPlus_OrbitalBlasterCannonBlueHE = true;
force ScifiSupportPlus_OrbitalBlasterCannonRed = false;
