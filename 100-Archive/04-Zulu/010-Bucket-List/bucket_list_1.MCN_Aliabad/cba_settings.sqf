...
// ARCA - Katarn_OS
force arca_katarnOS_intercom_enabled = true;
force arca_katarnOS_lowLight_enabled = true;
force arca_katarnOS_shield_duration = 240;
force arca_katarnOS_shield_maxCharges = 3;
...
// ARCA - Regular Weapons
force arca_weapons_r_ion_charge_max = 5;
force arca_weapons_r_stun_charge_max = 5;

// ARCA - Zeus
force arca_zeus_ZEN_useTraits = true;
...
DCOnoGroupReset = false;
DCOnoHideGlobal = false;
DCOnoPushGlobal = false;
DCOnoSmoke = false;
FSMD3Bugger = false;
globalAgressionMultiplier = 1;
iterationTimer = 2;
VehicleAutoRepair = true;
VehMinimumDistance = 450;
...
zen_faction_filter_0_arca_factions_cis = true;
...
zen_faction_filter_1_BAC_228thEC = true;
...
zen_faction_filter_1_MRBlack_Clones = true;
