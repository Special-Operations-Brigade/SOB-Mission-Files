...
force ace_medical_painUnconsciousThreshold = 0.75;
...
force mti_medical_pba_speed_boost = 1.1;
...
zen_faction_filter_0_O_3AS_CISV1 = true;
zen_faction_filter_0_O_3AS_CISV2 = true;
