[[],{
	...
	CIVPOP_fnc_startSystem = {
		...
		allCivilianClassNames = [
			"mti_factions_civilian_unit_Common_random",
			"mti_factions_civilian_unit_Paramedic",
			"mti_factions_civilian_unit_Paramedic_War",
			"mti_factions_civilian_unit_Prisoner",
			"mti_factions_civilian_unit_Rural_random",
			"mti_factions_civilian_unit_Worker_random"
		];
