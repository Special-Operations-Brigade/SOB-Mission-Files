...
["MTI_BARM_Shotgun", "mti_factions_mag_purple_shotgun_slug", ""],
    ...
    ["MTI_RD4", "mti_Mag_RD4_3rnd", ""],
    ["MTI_NT", "mti_Mag_NT_HE", ""],
    ["MTI_DC15A_HP", "mti_Mag_DC15A_HP", ""], 
    ["mti_factions_weapon_e5", "mti_factions_mag_carbine", ""], 
    ["mti_factions_weapon_galaar_scatter", "mti_factions_mag_yellow_shotgun_slug", ""],
    ["mti_factions_zombies_Zombie_Launcher", "mti_factions_zombies_headcrab_canister_8rd", ""],
    ["MTI_EE2", "mti_Mag_EE2", ""], 
    ["mti_factions_weapon_e5", "mti_factions_mag_green_carbine", ""], 
    ["mti_factions_weapon_e5", "mti_factions_mag_grey_carbine", ""], 
    ["mti_factions_weapon_e5", "mti_factions_mag_ice_carbine", ""], 
    ["mti_factions_weapon_e5", "mti_factions_mag_lime_carbine", ""], 
    ["mti_factions_weapon_e5", "mti_factions_mag_purple_carbine", ""], 
...
fnc_spawnLoot = {
    ...
    if (isNil "DB_globalBuildingIndex") then { DB_globalBuildingIndex = 0; };
    {
        ...
        if !(_building getVariable ["hasLoot", false]) then {
            if ((_bIdx % 6) == 0) then { // Only spawn loot in every 4th building globally (increased from every 8th)
                ...
                if (count _positions > 0) then {
                    ...
                    // Fill crate with 5-9 random weapons/items (increased from 3-6)
                    _numLoot = 5 + floor random 5;
