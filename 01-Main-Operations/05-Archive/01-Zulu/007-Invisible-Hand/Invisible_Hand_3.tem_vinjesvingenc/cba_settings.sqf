...
force ace_medical_deathChance = 0.1;
...
force ace_medical_treatment_cprSuccessChanceMax = 0.1;
...
force adv_aceCPR_chance_0 = 25;
force adv_aceCPR_chance_1 = 45;
...
force CBRN_factionMask_3AS_CIS = "";
force CBRN_factionMask_3AS_CIS_Human = "";
force CBRN_factionMask_3AS_Rep = "";
force CBRN_factionMask_ARCA_Units = "";
...
force CBRN_factionMask_CG_Bastion = "";
...
force CBRN_factionMask_JLTS_CIS = "";
force CBRN_factionMask_JLTS_contraband = "";
force CBRN_factionMask_JLTS_GAR = "";
force CBRN_factionMask_JLTS_meme_units = "";
force CBRN_factionMask_JLTS_modules = "";
force CBRN_factionMask_JMSLLTE_empire_fact = "";
force CBRN_factionMask_JMSLLTE_mimbLibA = "";
force CBRN_factionMask_JMSLLTE_scumFact = "";
force CBRN_factionMask_LS_CIS = "";
force CBRN_factionMask_LS_CIV = "";
force CBRN_factionMask_LS_CSF = "";
force CBRN_factionMask_LS_GAR = "";
force CBRN_factionMask_LS_MANDALORIAN = "";
force CBRN_factionMask_LS_MEMEFOR = "";
force CBRN_factionMask_LS_ORSF = "";
force CBRN_factionMask_LS_REPNAVY = "";
force CBRN_factionMask_LS_SHADOWCOLLECTIVE = "";
force CBRN_factionMask_LS_SOB = "";
force CBRN_factionMask_LW_Faction = "";
force CBRN_factionMask_O_3AS_CISV1 = "";
force CBRN_factionMask_O_3AS_CISV2 = "";
force CBRN_factionMask_O_3AS_CISV3 = "";
...
force CBRN_factionMask_OPTRE_CAA = "";
force CBRN_factionMask_OPTRE_FC_Covenant = "";
force CBRN_factionMask_OPTRE_Ins = "";
force CBRN_factionMask_OPTRE_PD = "";
force CBRN_factionMask_OPTRE_UEG_Civ = "";
force CBRN_factionMask_OPTRE_UNSC = "";
force CBRN_factionMask_prop = "";
force CBRN_factionMask_SWLB_GAR = "";
force CBRN_factionMask_SWLB_GAR_SOB = "";
force CBRN_factionMask_Virtual_F = "";
force CBRN_factionMask_WBK_AI = "";
force CBRN_factionMask_WBK_AI_Melee = "";
force CBRN_factionMask_WBK_AI_StarWars_Droids = "";
